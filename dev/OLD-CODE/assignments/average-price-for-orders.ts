...
const AveragePriceForOrders = () => {
  ...
  return /*html*/ `
    <div>
      ...
      <div class="solutionLink"><a href="https://github.com/WD23-D04/042-js-function-practice/blob/dev/src/pages/${user}/average-price-für-ordner.ts" target="_blank">Lösung anzeigen</a></div>
      <div class="solution">
        <div id = "firstDiv">
